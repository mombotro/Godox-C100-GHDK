...
This kit does not contain Godox firmware. Get the official file from the Godox site. See README.md.
...
Proof build: `gp_cardvr_upgrade.BAYER.bin` (SIDECAR6T). That file is a research build. It is not in this kit.
...
Hashes are SHA-256 prefixes (16 hex) unless noted. All files are 1 841 152 bytes. Research builds are not in this kit.

### Keep / products

| File | Hash prefix | Notes |
|---|---|---|
| `ORIGINAL/gp_cardvr_upgrade.bin` | `769733179a81f943…79b64` full | Stock vault |
| `BAYER.bin` | `4423e89e0b7da538` | Flagged. Same as 6T. Chip id `0x2083` |
